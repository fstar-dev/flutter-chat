 ...
 *
 * Built on 2023-02-07 at 15:01 UTC
 */
...
class _StringsZh implements _StringsEn {
	...
	@override String k_03iqsh4({required Object s}) => '$s为 ';
	@override String k_191t5n4({required Object opUserNickName}) => '$opUserNickName修改';
	@override String k_1pg6aoj({required Object opUserNickName}) => '$opUserNickName退出群聊';
	@override String k_1f6zt3v({required Object invitedMemberString}) => '邀请$invitedMemberString加入群组';
	@override String k_0y7zd07({required Object invitedMemberString}) => '将$invitedMemberString踢出群组';
	@override String get k_03c49qt => '去授权';
	@override String k_1d5mshh({required Object joinedMemberString}) => '用户$joinedMemberString加入了群聊';
	...
	@override String k_0spotql({required Object adminMember}) => '将 $adminMember 设置为管理员';
	@override String k_0pg5zzj({required Object operationType}) => '系统消息 $operationType';
	@override String k_0ohzb9l({required Object callTime}) => '通话时间：$callTime';
	@override String get k_1uaqed6 => '[自定义]';
	@override String get k_0z2z7rx => '[语音]';
	@override String get k_0y39ngu => '[表情]';
	@override String k_1c7z88n({required Object fileName}) => '[文件] $fileName';
	...
	@override String k_0qba4ns({required Object yoursItem}) => '想访问您的$yoursItem';
	...
	@override String k_0oozw9x({required Object diffMinutes}) => '$diffMinutes 分钟前';
	...
	@override String k_02owlq8({required Object userID}) => '我的用户ID: $userID';
	@override String k_1wu8h4x({required Object showName}) => '我是: $showName';
	@override String get k_16758qw => '添加好友';
	@override String k_1shx4d9({required Object selfSignature}) => '个性签名: $selfSignature';
	...
	@override String k_1uh417q({required Object displayName}) => '$displayName撤回了一条消息';
	...
	@override String k_0y9u662({required Object appName}) => '“$appName”暂不可以打开此类文件，你可以使用其他应用打开并预览';
	...
	@override String k_0w9x8gw({required Object successPath}) => '选择成功$successPath';
	...
	@override String k_1969986({required Object callingLastMsgShow}) => '[语音通话]：$callingLastMsgShow';
	@override String k_1960dlr({required Object callingLastMsgShow}) => '[视频通话]：$callingLastMsgShow';
	...
	@override String k_0bxm97s({required Object adminNum}) => '管理员 ($adminNum/10)';
	@override String get k_0k5u935 => '添加管理员';
	@override String get k_03enyx5 => '群成员';
	@override String k_0jayw3z({required Object groupMemberNum}) => '群成员($groupMemberNum人)';
	...
	@override String k_03xd79d({required Object signature}) => '个性签名: $signature';
	...
	@override String k_1ui5lzi({required Object count}) => '$count条相关聊天记录';
	@override String get k_09khmso => '相关聊天记录';
	@override String k_1kevf4k({required Object receiver}) => '与$receiver的聊天记录';
...
extension on _StringsZh {
	Map<String, dynamic> _buildFlatMap() {
		return {
			...
			'k_1f6zt3v': ({required Object invitedMemberString}) => '邀请$invitedMemberString加入群组',
			'k_0y7zd07': ({required Object invitedMemberString}) => '将$invitedMemberString踢出群组',
			'k_03c49qt': '去授权',
			'k_1d5mshh': ({required Object joinedMemberString}) => '用户$joinedMemberString加入了群聊',
			'k_002wddw': '禁言',
			'k_0got6f7': '解除禁言',
			...
			'k_0h19hfx': '拒绝通话',
			'k_0obi9lh': '超时未接听',
			'k_0y9u662': ({required Object appName}) => '“$appName”暂不可以打开此类文件，你可以使用其他应用打开并预览',
			'k_001nmhu': '用其他应用打开',
			'k_1ht1b80': '正在接收中',
			'k_105682d': '图片加载失败',
			'k_0pytyeu': '图片保存成功',
			...
			'k_003ll77': '草稿',
			'k_03icaxo': '自定义',
			'k_1969986': ({required Object callingLastMsgShow}) => '[语音通话]：$callingLastMsgShow',
			'k_1960dlr': ({required Object callingLastMsgShow}) => '[视频通话]：$callingLastMsgShow',
			...
			'k_0k5u935': '添加管理员',
			'k_03enyx5': '群成员',
			'k_0jayw3z': ({required Object groupMemberNum}) => '群成员($groupMemberNum人)',
			'k_0h1svv1': '删除群成员',
			'k_0h1g636': '添加群成员',
